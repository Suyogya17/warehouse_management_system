...
//   if (!selectedVariant) return null;const isInCart = cartProductIds.has(
//   Number(selectedVariant.id)
// );

//   const isLowStock = Number(selectedVariant.display_quantity || 0) < 10;

//   const isOutOfStock = Number(selectedVariant.display_quantity || 0) <= 0;
...
//     ? Math.floor(
//         Number(selectedVariant.display_quantity || 0) /
...
//               {formatNumber(selectedVariant.display_quantity)}{" "}
