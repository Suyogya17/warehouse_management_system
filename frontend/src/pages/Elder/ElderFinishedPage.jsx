          ...
          const matchStock =
            filters.stock === "low"
              ...
              : filters.stock === "available"
                ? availableQty >= 10
                : true;
          return matchSearch && matchSize && matchStock && matchSeries && matchCommission && matchNClassification;
      ...
      {/* FILTERS */}
         <SectionCard title="Filters">
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <button
              onClick={() => setFilters({ search: "", size: "", stock: "all", series: "", commission: "all", nClassification: "all" })}
