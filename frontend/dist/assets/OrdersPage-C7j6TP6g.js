import{r as o,u as He,a as Ye,k as Qe,d as v,j as t,f as w,B as u,l as xe,m as ye,n as Ze}from"./index-iCx3zt2D.js";import{D as Je}from"./DataTable-8894isCg.js";import{F as b,T as f,S as Xe,a as et}from"./Field-C88ka22a.js";import{S as ve}from"./SectionCard-w6GEV2ZR.js";import{S as se}from"./StatCard-Cvyz8MuV.js";import{S as tt}from"./StatusBadge-DwDuCQkX.js";import{u as at,a as R}from"./useDataRefresh-CUgvc4eL.js";import{S as fe}from"./react-select.esm-DN6JFc0z.js";import{S as rt}from"./search-CKKcpfzZ.js";import"./EmptyState-CboXRFSm.js";import"./index-8JwjhRSi.js";const Ne={customer_name:"",customer_phone:"",customer_address:"",pan_number:"",transport_name:"",notes:"",items:[{finished_good_id:"",qty_ordered:1}]},st={PENDING:"warning",CONFIRMED:"info",PACKED:"neutral",DELIVERED:"success",CANCELLED:"danger"},nt=["CONFIRMED","PACKED","DELIVERED"],je=[{value:"DUPLICATE_ORDER",label:"Duplicate order"},{value:"CUSTOMER_CHANGED_MIND",label:"Customer changed mind"},{value:"INCORRECT_PRODUCT_OR_QUANTITY",label:"Incorrect product or quantity"},{value:"INSUFFICIENT_STOCK",label:"Insufficient stock"},{value:"PRICING_ISSUE",label:"Pricing issue"},{value:"DELIVERY_ISSUE",label:"Delivery issue"},{value:"OTHER",label:"Other"}],Ce=N=>{var A;return((A=je.find(T=>T.value===N))==null?void 0:A.label)||"Other"},ot=new Set(["suyogya shrestha","suyogya shresth","suvarna shrestha","hirdaya shrestha"]),lt=(N={})=>String(N.role||"").toUpperCase()==="CO_ADMIN"&&ot.has(String(N.name||"").trim().replace(/\s+/g," ").toLowerCase());function ft(){const[N,A]=o.useState(""),[T,it]=o.useState(""),{token:p,user:D}=He(),{showToast:g}=Ye(),k=Qe(D==null?void 0:D.role,["ADMIN","CO_ADMIN"]),we=lt(D),[Q,De]=o.useState([]),[O,L]=o.useState(1),[$,Se]=o.useState({page:1,per_page:50,total:0,total_pages:1}),[ne,Ee]=o.useState(""),[C,ke]=o.useState([]),[oe,Oe]=o.useState([]),[m,x]=o.useState(Ne),[q,Pe]=o.useState("ALL"),[M,z]=o.useState(null),[F,S]=o.useState([]),[le,Z]=o.useState(""),[U,ie]=o.useState(!1),[B,G]=o.useState(null),[P,de]=o.useState("DUPLICATE_ORDER"),[ce,ue]=o.useState(""),[J,X]=o.useState(""),[V,me]=o.useState(!1);o.useEffect(()=>{const e=window.setTimeout(()=>{Ee(N.trim()),L(1)},300);return()=>window.clearTimeout(e)},[N]);const W=o.useCallback(async()=>{const e=await v.getOrders(p,{page:O,per_page:50,search:ne,status:q==="ALL"?void 0:q});De(e.data||[]),Se(e.pagination||{page:O,per_page:50,total:(e.data||[]).length,total_pages:1})},[ne,O,q,p]),K=o.useCallback(async()=>{const[e,a]=await Promise.all([v.getAvailability(p,{includeHidden:k}),v.getWarehouseStock(p)]);ke(e.data||[]),Oe(a.data||[])},[k,p]),E=o.useCallback(()=>Promise.all([W(),K()]),[W,K]);o.useEffect(()=>{W().catch(console.error)},[W]),o.useEffect(()=>{K().catch(console.error)},[K]),o.useEffect(()=>{O>Number($.total_pages||1)&&L(Number($.total_pages||1))},[O,$.total_pages]),at(E,"orders");const ee=o.useMemo(()=>new Map(C.map(e=>[String(e.id),e])),[C]),Ie=o.useMemo(()=>{const e=new Map;return oe.forEach(a=>{const s=String(a.finished_good_id),r=e.get(s)||[];r.push(a),e.set(s,r)}),e},[oe]),te=C.reduce((e,a)=>(e.physical+=Number(a.physical_stock||0),e.reserved+=Number(a.reserved_qty||0),e.available+=Number(a.available_qty||0),e),{physical:0,reserved:0,available:0}),he=(e,a,s)=>{x(r=>({...r,items:r.items.map((c,n)=>n===e?{...c,[a]:s}:c)}))},Re=async e=>{var a,s,r;e.preventDefault();try{const c={...m,customer_name:m.customer_name.trim(),customer_phone:m.customer_phone.trim(),customer_address:m.customer_address.trim(),pan_number:m.pan_number.trim(),transport_name:m.transport_name.trim(),notes:m.notes.trim(),items:m.items.map(n=>({finished_good_id:Number(n.finished_good_id),qty_ordered:Number(n.qty_ordered)}))};try{await v.createOrder(c,p)}catch(n){if(n.status!==409||((a=n.data)==null?void 0:a.code)!=="POTENTIAL_DUPLICATE_ORDER")throw n;const i=(r=(s=n.data)==null?void 0:s.duplicates)==null?void 0:r[0];if(!window.confirm(["Possible duplicate order detected.",i?`Order #${i.id} for ${i.customer_name} already has the same products and quantities.`:"A recent order already has the same customer, products and quantities.",i!=null&&i.created_by_name?`Created by: ${i.created_by_name}`:null,"Create another order anyway?"].filter(Boolean).join(`

`)))return;await v.createOrder({...c,confirm_duplicate:!0},p)}x(Ne),await E(),R("orders"),g({tone:"success",title:"Order reserved",message:"Available stock was refreshed."})}catch(c){g({tone:"error",title:"Order failed",message:c.message})}},H=async(e,a,s={})=>{try{return await v.updateOrderStatus(e,{status:a,...a==="CANCELLED"?s:{}},p),await E(),R("orders"),g({tone:"success",title:"Order updated",message:`Order marked ${a.toLowerCase()}.`}),!0}catch(r){return g({tone:"error",title:"Order update failed",message:r.message}),!1}},Ae=e=>{G(e),de("DUPLICATE_ORDER"),ue(""),X("")},Te=async e=>{if(e.preventDefault(),!B)return;const a=ce.trim()||Ce(P);me(!0);try{await H(B.id,"CANCELLED",{cancellation_code:P,cancellation_reason:a,...P==="DUPLICATE_ORDER"&&Number(J)>0?{duplicate_of_order_id:Number(J)}:{}})&&G(null)}finally{me(!1)}},Le=async e=>{try{const a=await v.assignOrderDeliveryNote(e.id,p);await E(),R("orders"),g({tone:"success",title:"Delivery note assigned",message:a.message||`A delivery-note number was assigned to Order #${e.id}.`})}catch(a){g({tone:"error",title:"Could not assign DN",message:a.message})}},$e=async e=>{const a=window.prompt(`Why are you reopening packing for Order #${e.id}?

The existing delivery note number will remain unchanged.`);if(a===null)return;const s=a.trim();if(!s){g({tone:"error",title:"Reason required",message:"Enter why this packed order needs to be corrected."});return}try{const r=await v.reopenOrderPacking(e.id,s,p);await E(),R("orders"),g({tone:"success",title:"Packing reopened",message:r.message||`${e.delivery_note_number||"Delivery note"} was preserved. You can now correct CTN.`})}catch(r){g({tone:"error",title:"Could not reopen packing",message:r.message})}},qe=e=>{z(e),Z(""),S((e.items||[]).map(a=>({finished_good_id:String(a.finished_good_id),carton_qty:Number(a.inner_boxes_per_outer_box)>0?Number(a.qty_ordered||0)/Number(a.inner_boxes_per_outer_box):""})))},Me=async e=>{if(e.preventDefault(),!!M){ie(!0);try{await v.correctOrderItems(M.id,{reason:le.trim(),items:F.map(a=>({finished_good_id:Number(a.finished_good_id),carton_qty:Number(a.carton_qty)}))},p),z(null),S([]),Z(""),await E(),R("orders"),g({tone:"success",title:"Order corrected",message:"Reserved stock was recalculated automatically."})}catch(a){g({tone:"error",title:"Correction failed",message:a.message})}finally{ie(!1)}}},ze=e=>t.jsx("div",{className:"space-y-1",children:e.items.map(a=>t.jsxs("p",{children:[a.product_name," - ",w(a.qty_ordered)," ",a.unit]},a.id))}),Fe=Q;o.useMemo(()=>C.filter(e=>{var s,r,c;const a=T.toLowerCase();return((s=e.name)==null?void 0:s.toLowerCase().includes(a))||((r=e.article_code)==null?void 0:r.toLowerCase().includes(a))||((c=e.color)==null?void 0:c.toLowerCase().includes(a))}),[C,T]);const pe=o.useMemo(()=>new Map(Q.filter(e=>e.delivery_note_number).map(e=>[Number(e.id),e.delivery_note_number])),[Q]),_=e=>String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),I=e=>Number(e||0).toLocaleString(void 0,{maximumFractionDigits:2}),Ue=(e=[],a=0)=>{let s=Number(a||0);const r=[],c=[...e].filter(n=>Number(n.quantity||0)>0).sort((n,i)=>{const h=new Date(n.updated_at||0).getTime(),j=new Date(i.updated_at||0).getTime();return h!==j?h-j:Number(n.id||0)-Number(i.id||0)});for(const n of c){if(s<=0)break;const i=Number(n.quantity||0),h=Math.min(i,s);r.push({warehouse_name:n.warehouse_name,quantity:h}),s-=h}return r},Be=(e="")=>{const a=new Date,s=xe(a,{includeTime:!1}),r=ye(a),c=a.toLocaleTimeString(),n=e.delivery_note_number||pe.get(Number(e.id))||"-",i=(e.items||[]).map(l=>{const d=ee.get(String(l.finished_good_id)),ae=Number(l.qty_ordered||0),re=Number(l.inner_boxes_per_outer_box||(d==null?void 0:d.inner_boxes_per_outer_box)||0),Ve=re>0?ae/re:0,be=l.warehouse_allocations||[],We=Ie.get(String(l.finished_good_id))||[],Ke=(be.length?be:Ue(We,ae)).filter(Y=>Number(Y.quantity||0)>0).map(Y=>`${Y.warehouse_name} (${I(Y.quantity)})`).join(", ")||"-";return{...l,pairs:ae,pairsPerCarton:re,cartons:Ve,finished_good_id:l.finished_good_id||(d==null?void 0:d.id)||"-",product_id:l.product_id||l.article_code||(d==null?void 0:d.article_code)||"-",product_size:l.product_size||(d==null?void 0:d.size)||"-",warehouse_name:Ke}}),h=i.reduce((l,d)=>l+d.pairs,0),j=i.reduce((l,d)=>l+d.cartons,0),Ge=i.map((l,d)=>`
          <tr>
            <td style="border:1px solid black;padding:6px;text-align:center;">
              ${d+1}
            </td>
            <td style="border:1px solid black;padding:6px;text-align:center;">
              ${_(l.finished_good_id)}
            </td>
            ...
            <td style="border:1px solid black;padding:6px;text-align:center;">
              ${I(l.pairs)} ${_(l.unit||"pairs")}
            </td>
          </tr>
        `).join(""),y=window.open("","_blank","width=900,height=700");if(!y){g({tone:"error",title:"Print blocked",message:"Allow popups for this site and try printing again."});return}v.logOrderPrint(e.id,p).catch(()=>{}),y.document.open(),y.document.write(`
      <!doctype html>
      <html>
        <head>
          ...
          <table class="top-grid">
            <tr>
              <td width="60%">
                ...
                English Date: ${s}<br/>
                Time: ${c}<br/>
                <strong>Transport Name:</strong> ${_(e.transport_name||"-")}<br/>
                <strong>Gate Pass No:</strong><br/>
                <strong>Bill No:</strong><br/>
              </td>
              <td width="40%">
                <strong>Delivery Note No:</strong> ${n}<br/>
                <strong>Created By:</strong> ${_(e.created_by_name||"-")}<br/>
                <strong>Customer Name:</strong> ${_(e.customer_name)}<br/>
                <strong>Phone Number:</strong> ${_(e.customer_phone||"-")}<br/>
                <strong>Address:</strong> ${_(e.customer_address||"-")}<br/>
                <strong>PAN Number:</strong> ${_(e.pan_number||"-")}
              </td>
            </tr>
          </table>
